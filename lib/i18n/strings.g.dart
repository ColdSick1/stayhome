...
///
/// Built on 2023-07-06 at 09:08 UTC
...
class _StringsRu implements _StringsEn {
	...
	@override String get authorization => 'Войти';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'forgetPassword': return 'Forgot your password?';
...
extension on _StringsRu {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'forgetPassword': return 'Забыли пароль?';
			case 'authorization': return 'Войти';
